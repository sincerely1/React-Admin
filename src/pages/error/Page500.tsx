...
import cat3 from '@/assets/images/characters/cat3.png';
      ...
      <div className="m-auto max-w-[400px]">
        <MotionContainer className="flex flex-col items-center justify-center px-2">
          ...
          <m.div variants={varBounce().in}>
            ...
            >
              <defs>
                <linearGradient id="BG3" x1="19.496%" x2="77.479%" y1="71.822%" y2="16.69%">
              ...
              />
              {/* character */}
              <image href={cat3} height="180" x="300" y="130" />
              <path
                fill={colorPrimary}
