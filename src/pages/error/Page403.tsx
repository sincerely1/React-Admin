...
import cat2 from '@/assets/images/characters/cat2.png';
      ...
      <div className="m-auto max-w-[400px]">
        <MotionContainer className="flex flex-col items-center justify-center px-2">
          ...
          <m.div variants={varBounce().in}>
            ...
            >
              <defs>
                <linearGradient id="BG1" x1="19.496%" x2="77.479%" y1="71.822%" y2="16.69%">
              ...
              <path
                ...
                opacity="0.2"
              />
              <image href={cat2} height="300" x="220" y="30" />
              <path
                fill={colorPrimary}
