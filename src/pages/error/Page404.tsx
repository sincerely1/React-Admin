...
import cat1 from '@/assets/images/characters/cat1.png';
      ...
      <div className="m-auto max-w-[400px]">
        <MotionContainer className="flex flex-col items-center justify-center px-2">
          ...
          <m.div variants={varBounce().in}>
            ...
            >
              <defs>
                <linearGradient id="BG2" x1="19.496%" x2="77.479%" y1="71.822%" y2="16.69%">
              ...
              />
              {/* character */}
              <image href={cat1} height="300" x="205" y="30" />
              {/* sun */}
              <path
                fill="#FFAB00"
